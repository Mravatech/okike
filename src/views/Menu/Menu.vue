<template>
  <div class="menu-page animated">
    <div class="nav-left">
      <div class="menu-btn">
        <a @click="$router.go(-1)">
          <img src="../../assets/images/menu_btn.svg" />
        </a>
      </div>
    </div>
    <div class="nav-right">
      <div class="nav-right-inner">
        <div class="menu-top-right">
          ...
          <div class="wallet-amount">
            <h3>₦{{ user.wallet_balance_naira }}</h3>
            <p>
              <img src="../../assets/images/coin2.svg" />
              {{ user.wallet_balance }}
            </p>
          </div>
        </div>
        <div class="menu-nav-tabs">
          ...
          <div class="menu-nav-tab">
            <!--<img src="../../assets/images/naira-icon.svg" >-->
            <!--<p>Add Cash</p>-->
            <b-button class="menu-button" v-b-modal.modal-center>
              <img src="../../assets/images/naira-icon.svg" />
              <p>Fund Wallet</p>
            </b-button>
            ...
            <b-modal centered class="fixed-bottom" hide-footer hide-header id="modal-center">
              ...
              <router-link to="AddCash">
                ...
                <div class="my-profile2">
                  <div>
                    <img src="../../assets/images/card-green.svg" />
                  </div>
                  <div>
                    <p>Add Cash ATM/Banks Card</p>
                  </div>
                </div>
              </router-link>
              <router-link to="AddCashQuickteller">
                <div class="my-profile2">
                  <div>
                    <img src="../../assets/images/quickteller.svg" />
                  </div>
                  <div>
              ...
              <router-link to="BankTransfer">
                <div class="my-profile2">
                  <div>
                    <img src="../../assets/images/banktransfer.svg" />
                  </div>
                  <div>
...
.nav-right-inner {
  height: 100vh;
  background: url("../../assets/images/logo_menu_bg.png") bottom 0px right
    no-repeat;
